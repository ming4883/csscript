...
"%net4_tools%\csc.exe" /nologo /nowarn:169,618 /o /define:fork_x86,net4 /out:cscs.exe /t:exe %common_source_files% ..\cscscript\CSExecutionClient.cs ..\cscscript\Properties\AssemblyInfo.cs /win32icon:..\Logo\css_logo.ico  %common_4_params% /r:"%net4_asms%\System.dll" /r:"%net4_asms%\System.Data.dll" /r:"%net4_asms%\System.XML.dll" /r:"%net4_asms%\System.Windows.Forms.dll" /r:"%net4_asms%\System.Core.dll" >> build.log
ECHO ------------ >> build.log
...
"%net4_tools%\csc.exe"/nologo /nowarn:169,618 /o /define:fork_x86,net4 /out:csws.exe /t:winexe %common_source_files% ..\cswscript\CSExecutorClient.cs ..\cswscript\Properties\AssemblyInfo.cs /win32icon:..\Logo\css_logo.ico  %common_4_params%  /r:"%net4_asms%\System.dll" /r:"%net4_asms%\System.Data.dll" /r:"%net4_asms%\System.XML.dll" /r:"%net4_asms%\System.Core.dll" /r:"%net4_asms%\System.Windows.Forms.dll" >> build.log
ECHO ------------ >> build.log

ECHO Building csws32.exe:
ECHO Building csws32.exe: >> build.log
"%net4_tools%\csc.exe" /nologo /nowarn:169,618 /o /platform:x86 /define:net4 /out:csws32.exe /t:winexe %common_source_files% ..\cswscript\CSExecutorClient.cs ..\cswscript\Properties\AssemblyInfo.cs %common_4_params% /win32icon:..\Logo\css_logo.ico  /r:"%net4_asms%\System.dll" /r:"%net4_asms%\System.Data.dll" /r:"%net4_asms%\System.XML.dll" /r:"%net4_asms%\System.Core.dll" /r:"%net4_asms%\System.Windows.Forms.dll" >> build.log
ECHO ------------ >> build.log
...
copy CSScriptLibrary.v3.5.dll "%local_dev%\Samples\Hosting\CodeDOM\VS2008 project\Lib\CSScriptLibrary.v3.5.dll"
copy CSScriptLibrary.v3.5.xml "%local_dev%\Samples\Hosting\CodeDOM\VS2008 project\Lib\CSScriptLibrary.v3.5.xml"
...
copy ..\CSScriptLibrary\bin\Release.4.0\CSScriptLibrary.dll "%local_dev%\Samples\Hosting\CodeDOM\VS2010 project\Lib\CSScriptLibrary.dll"
copy ..\CSScriptLibrary\bin\Release.4.0\CSScriptLibrary.xml "%local_dev%\Samples\Hosting\CodeDOM\VS2010 project\Lib\CSScriptLibrary.xml"
...
copy CSScriptLibrary.xml "%local_dev%\Samples\Hosting\CodeDOM\VS2012 project\Lib\CSScriptLibrary.xml"
copy CSScriptLibrary.dll "%local_dev%\Samples\Hosting\CodeDOM\VS2012 project\Lib\CSScriptLibrary.dll"
